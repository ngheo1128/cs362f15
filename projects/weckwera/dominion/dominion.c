...
//Function for the refactored Remodel card
int remodelCard(struct gameState *state, int currentPlayer,
        int choice1, int choice2, int handPos)
{
    int i;
    int j;
...
//
    ...
    case village:
      ...
      //for non-separate-function implementation:
      ////+1 Card
      //drawCard(currentPlayer, state);
