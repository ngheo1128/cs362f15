...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
      return adventurerRef(z, handPos, currentPlayer, cardDrawn, state, temphand, drawntreasure);    // call to refactored
    ...
    case smithy:
        return smithyRef(handPos, currentPlayer, state);        // call to refactored

    case village:
        return villageRef(handPos, currentPlayer, state);               // call to refactored

    case baron:
        return baronRef(handPos, currentPlayer, state, choice1);        // call refactored
    ...
    case steward:
      return stewardRef(handPos, currentPlayer, state, choice1, choice2, choice3);     // refactored
...
*******************************************************************/
int adventurerRef(int z, int handPos, int currentPlayer, int cardDrawn, struct gameState *state, int temphand[], int drawntreasure){
...
*******************************************************************/
int villageRef(int handPos, int currentPlayer, struct gameState *state){
      //+1 Card
      drawCard(currentPlayer, state);
...
*******************************************************************/
int stewardRef(int handPos, int currentPlayer, struct gameState *state, int choice1, int choice2, int choice3){
    if (choice1 == 1)
    {
        //+2 cards
        drawCard(currentPlayer, state);
...
*******************************************************************/
int baronRef(int handPos, int currentPlayer, struct gameState *state, int choice1){
