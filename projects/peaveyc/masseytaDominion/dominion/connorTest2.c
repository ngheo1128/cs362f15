...
int randTestAdventurer(){
    ...
    adventurerRef(0, 0, whoseTurn, 0, game, tempHand, 0);
    ...
    if(error == 1){
        ...
        for(i=0; i<numPlayers; i++){
            offset = 0;
            printf("Dump of discard of player %d before Adventure:", i);
            ...
            printf("\nDump of deck of player %d before Adventure:", i);
        ...
        for(i=0; i<game->numPlayers; i++){
            offset = 0;
            printf("Dump of discard of player %d after Adventure:", i);
            for(j=0; j<game->discardCount[i]; j++){
            ...
            printf("\nDump of deck of player %d after Adventure:", i);
            for(j=0; j<game->deckCount[i]; j++){
