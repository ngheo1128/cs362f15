...
void playFeast(struct gameState *state, int choice1) {
	int temphand[MAX_HAND];
	int i; //loop counter
	int currentPlayer = whoseTurn(state);
...
//parameters to playCard: int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus
void playRemodel(struct gameState *state, int choice1, int choice2, int handPos) {
	int currentPlayer = whoseTurn(state);
