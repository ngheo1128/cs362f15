/*
MiltonS Test Results
====================

cardtest1.c
	This tested the Smithy Card. Test ran without a hitch.
	Bugs found:
		1. Card count not correctly increased

cardtest2.c
	This tested the Adventurer Card. Test ran without a hitch.
	Bugs found:
		1. Deck not properly resized
		2. Cards are not properly discarded
		
cardtest3.c
	This tested the Village Card. Test ran without a hitch. No bugs were found.
...
randomtestadventurer.c
	This was a random test for the Adventurer Card. All 1000 tests were completed.
	812/1000 tests failed.
	Bugs found:
		1. Failed to increase number of cards by 2.

randomtestcard.c
	This was a random card test for the Steward Card.
	1000/1000 tests failed.
	Bugs found:
		1. Failed to increaes number of cards by 2.
