...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case adventurer:
      ...
      return adventurer_card(currentPlayer, cardDrawn, drawntreasure, z, temphand, state);
    ...
    case village:
      ...
      return village_card(currentPlayer, handPos, state);
    ...
    case steward:
      ...
      return steward_card(currentPlayer, handPos, state, choice1, choice2, choice3);
