...
int main(int argc, char *argv[]){
    ...
    cardEffect_adventurer(&state, 0);

    printf("cardEffect_adventurer(): %s empty hand case\n", 
        (state.handCount[0] == 2 &&
    ...
    printf("cardEffect_adventurer(): %s not enough Treasure case\n", 
        (state.handCount[0] == 1 &&
    ...
    printf("cardEffect_adventurer(): %s full deck case\n", 
        (state.handCount[0] == 2 &&
    ...
    printf("cardEffect_adventurer(): %s empty deck case\n", 
        (state.handCount[0] == 2 &&
        state.discardCount[0] == 2 &&
        state.deckCount[0] == 0) ? "PASS" : "FAIL");
    ...
    /* clear verified changes made by cardEffect_adventurer() */
    ...
    printf("cardEffect_adventurer(): %s changes to correct player only\n", 
