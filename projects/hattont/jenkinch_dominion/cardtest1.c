...
int main(int argc, char *argv[]){
    ...
    activateAdventurer(&state, 0);

    printf("activateAdventurer(): %s empty hand case\n", 
        (state.handCount[0] == 2 &&
    ...
    printf("activateAdventurer(): %s not enough Treasure case\n", 
        (state.handCount[0] == 1 &&
    ...
    printf("activateAdventurer(): %s full deck case\n", 
        (state.handCount[0] == 2 &&
    ...
    printf("activateAdventurer(): %s empty deck case\n", 
        (state.handCount[0] == 2 &&
        state.discardCount[0] == 2 &&
        state.deckCount[0] == 0) ? "PASS" : "FAIL");
    ...
    /* clear verified changes made by activateAdventurer() */
    ...
    printf("activateAdventurer(): %s changes to correct player only\n", 
