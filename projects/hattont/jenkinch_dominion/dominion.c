...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    {
    case adventurer:
        return activateAdventurer(state, currentPlayer);
    ...
    case smithy:
        return activateSmithy(state, currentPlayer, handPos);

    case village:
        return activateVillage(currentPlayer, state, handPos);
    ...
    case minion:
        return activateMinion(currentPlayer, state, handPos, choice1, choice2);

    case steward:
        return activateSteward(currentPlayer, state, handPos, choice1, choice2, choice3);
...
int activateSmithy(struct gameState *state, int currentPlayer, int handPos)
{
    int i = 0;
...
int activateAdventurer(struct gameState *state, int currentPlayer)
{
  int drawntreasure = 0;
