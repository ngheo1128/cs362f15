...
int main() {
    ...
    for (p = 0; p < numPlayer; p++)
    {
        ...
        for (handCount = 1; handCount <= maxHandCount; handCount++)
        {
            ...
            {
                printf("FAILURE: Checking for first silver card. Expected %d, received %d\n",silver, G.hand[p][G.handCount[p] -1]);
            }
#if (NOISY_TEST == 1)
            ...
            if (G.deckCount[p] != MAX_DECK-3)
            {
                printf("FAILURE: Deck Count. Expected %d, received %d\n",497,G.deckCount[p]);
            }
#if (NOISY_TEST == 1)
            printf("Num buys. Expected %d, received %d\n",1,G.numBuys);
#endif
...
#endif
            if(G.hand[p][G.handCount[p] -1] != gold)
            {
                printf("FAILURE: Checking for first gold card. Expected %d, received %d\n",gold, G.hand[p][G.handCount[p] -1]);
            }
#if (NOISY_TEST == 1)
    ...
    for (p = 0; p < numPlayer; p++)
    {
        ...
        for (handCount = 1; handCount <= maxHandCount; handCount++)
        {
            ...
            {
                printf("FAILURE: Checking for first copper card. Expected %d, received %d\n",copper, G.hand[p][G.handCount[p] -1]);
            ...
            if(G.hand[p][G.handCount[p] -2] != copper)
            {
                printf("FAILURE: Checking for second copper card. Expected %d, received %d\n",copper, G.hand[p][G.handCount[p] -2]);
            }
