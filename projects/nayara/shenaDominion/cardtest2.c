...
int main() {
    ...
    for (p = 0; p < numPlayer; p++)
    {
        ...
        for (handCount = 1; handCount <= maxHandCount; handCount++)
        {
            ...
            {
                printf("FAILURE: gold card. Expected %d, received %d\n",gold, G.hand[p][G.handCount[p] -1]);
            }
#if (NOISY_TEST == 1)
            ...
            if(G.hand[p][G.handCount[p] -2] != gold)
            {
                printf("FAILURE: Checking for second gold card. Expected %d, received %d\n",gold, G.hand[p][G.handCount[p] -2]);
            }
            ...
            {
                printf("FAILURE: for new hand count:  Expected %d, received %d\n",G.handCount[p],handCount +2);
