...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case adventurer:
      ...
      cardEffect_adventurer(currentPlayer, state);

      return 0;
			
    case council_room:
      
      cardEffect_council_room(handPos, currentPlayer, state);
    ...
    case remodel:
      ...
      return cardEffect_remodal(handPos, currentPlayer, state, choice1, choice2, choice3);
		
    case smithy:
      
      cardEffect_smithy(handPos, currentPlayer, state);
    ...
    case salvager:
      ...
      cardEffect_salvager(handPos, currentPlayer, state, choice1);
...
//Refactor smithy switch from cardEffect function
...
//Refactor adventurer switch from cardEffect function
...
//Refactor council_room switch from cardEffect function
...
//Refactor remodal switch from cardEffect function
...
//Refactor salvager switch from cardEffect function
