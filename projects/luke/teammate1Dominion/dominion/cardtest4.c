...
int main() {
	...
	steward_card(player1, &G, 0, 1, G.handCount[player1]-1, G.handCount[player1]-2);
	...
	steward_card(player1, &G, 0, 2, G.handCount[player1]-1, G.handCount[player1]-2);
	...
	steward_card(player1, &G, 0, 3, 1, 2);
