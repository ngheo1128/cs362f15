 ...
 * randomtestcard.c
 *
 * This file contains a random tester unit test of teammate 1's village card
 * function as part of the requirements for assignment 5.
 *
...
int main(int argc, char *argv[]) {
    ...
    for (k = 0; k < NUM_REPS; k++){
        ...
        comparisonState.whoseTurn = curPlayer;
        ...
        cardEffect(village, 0, 0, 0, &testState, handPos, NULL);
