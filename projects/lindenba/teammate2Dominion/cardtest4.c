...
int main() {
    int i, p, d, h, g, r;// p is numPlayer (player), d is deckSize, h is handSize, g position of cutpurse, r is to initialize new game
    int seed = 1000;
    int numPlayer = 2;
    int maxBonus = 10;
    int bonus;
...
#if (NOISY_TEST == 1)
                    printf("Test player = %d with deck size= %d hand= %d and position Cut Purse = %d.\n", p, d, h, g);
#endif
