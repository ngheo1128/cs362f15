...
int main() {
    int i, p, d, h, c, r;// p is numPlayer (player), d is deckSize, h is handSize, c position of treasure map, r is to initialize new game
    int seed = 1000;
    int numPlayer = 2;
...
#if (NOISY_TEST == 1)
                    printf("Test player = %d with deck size= %d hand= %d and position Treaseure Map = %d.\n", p, d, h, c);
#endif
