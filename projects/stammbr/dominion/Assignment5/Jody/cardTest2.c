...
void test(){
  ...
  if(callAdventurer(player, game) != 0){
    ...
    if(treasureCounter != 2){
      ...
      printf("%d:  callAdventurer():  PASSED initial.\n", counter);
    }
    counter++;
  }
  ...
  if(callAdventurer(player, game) != 0){
    ...
    if(treasureCounter != 2){
      ...
      printf("%d:  callAdventurer():  PASSED large deck.\n", counter);
    }
    counter++;
  }
  ...
  if(callAdventurer(player, game) != 0){
    ...
    if(treasureCounter != 2){
      ...
      printf("%d:  callAdventurer():  PASSED random.\n", counter);
    }
    counter++;
  }
  ...
  if(callAdventurer(player, game) != 0){
    ...
    if(treasureCounter > 0){
      ...
      printf("%d:  callAdventurer():  PASSED no treasure?.\n", counter);
    }
    counter++;
  }
  */
...
int main(int argc, char **argv){
	...
	printf("This is the tests for the Adventurer card, callAdventurer().\n");
...
int callAdventurer(struct gameState *state, int *temphand, int currentPlayer){
  int cardDrawn;
