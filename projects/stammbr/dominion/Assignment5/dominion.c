...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  if (card == adventurer){
    answer = adventurerMethod(state, temphand, currentPlayer);
    return answer;
  }

  else if (card == smithy){
    answer = smithyMethod(state, currentPlayer, handPos);
    return answer;
  }

  else if (card == village){
    answer = villageMethod(state, currentPlayer, handPos);
    return answer;
  }

  else if (card == council_room){
    answer = councilMethod(state, currentPlayer, handPos);
    return answer;
  }

  else if (card == feast){
    answer = feastMethod(state, temphand, currentPlayer, choice1);
    return answer;
  }
