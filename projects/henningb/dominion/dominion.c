...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case smithy:
        smithyCardEffect(handPos, currentPlayer, state);
        return 0;

    case village:
        villageCardEffect(handPos, currentPlayer, state);
        return 0;
    ...
    case steward:
        stewardCardEffect(handPos, currentPlayer, state, choice1, choice2, choice3);
        return 0;
