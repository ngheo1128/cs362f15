...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  {
  case adventurer:
    executeAdventurerCard(drawntreasure, state, currentPlayer);
    return 0;

  case council_room:
    executeCouncilRoomCard(state, currentPlayer, handPos);
    return 0;
  ...
  case smithy:
    executeSmithyCard(currentPlayer, state, handPos);
    return 0;

  case village:
    executeVillageCard(state, currentPlayer, handPos);
    return 0;
  ...
  case great_hall:
    executeGreatHallCard(state, currentPlayer, handPos);
    return 0;
...
void executeCouncilRoomCard(struct gameState *state, int currentPlayer, int handPos)
{
  int i;
...
void executeGreatHallCard(struct gameState *state, int currentPlayer, int handPos)
{
  drawCard(currentPlayer, state);
