...
void adventurerCard(int currentPlayer, struct gameState *state, int drawntreasure, int z, int temphand[MAX_HAND], int cardDrawn)
{
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	{
	case adventurer:
		adventurerCard(currentPlayer, state, drawntreasure, z, temphand, cardDrawn);
		return 0;
	...
	case minion:
		...
		minionCard(currentPlayer, state, handPos, choice1, choice2);
		return 0;
