...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case remodel:
      remodelCardPlayed(choice1,choice2,state,handPos);
      return 0;

    case smithy:
      //+3 Cards
      smithyCardPlayed(state,handPos);
      return 0;
    ...
    case great_hall:
      great_hallCardPlayed(state,handPos);
      return 0;

    case minion:
        minionCardPlayed(choice1,choice2,state,handPos);
        return 0;
