...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
	...
	//might as well just re-define temphand and carddrawn and z in the function
    ...
    case outpost:
	return outpostCard(currentPlayer, handPos, state);
...
int adventurerCard(int currentPlayer, struct gameState *state)
{
	...
	//bug: silver card does not update drawn treasure!
		drawntreasure++;
	}
	else{
