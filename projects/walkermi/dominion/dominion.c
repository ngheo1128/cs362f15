...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
        cardEffect_Adventurer(card, choice1, choice2, choice3, state, handPos, bonus, drawntreasure, currentPlayer, cardDrawn, temphand, z);
        return 0;
    ...
    case smithy:
        cardEffect_Smithy(card, choice1, choice2, choice3, state, handPos, bonus, currentPlayer, i);
        return 0;
		
    case village:
        cardEffect_Village(card, choice1, choice2, choice3, state, handPos, bonus, currentPlayer);
        return 0;
    ...
    case great_hall:
        cardEffect_GreatHall(card, choice1, choice2, choice3, state, handPos, bonus, currentPlayer);
        return 0;
    ...
    case salvager:
            cardEffect_Salvager(card, choice1, choice2, choice3, state, handPos, bonus, currentPlayer);
            return 0;
