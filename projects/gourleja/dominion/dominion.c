...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case council_room:
      //+4 Cards
      cardCouncilRoom(handPos, currentPlayer, state);
      return 0;
    ...
    case smithy:
      //+3 Cards
      cardSmithy(handPos, currentPlayer, state);
      return 0;
    ...
    case baron:
        cardBaron(choice1, handPos, currentPlayer, state);
        return 0;
    ...
    case salvager:
        //+1 buy
        cardSalvager(choice1, handPos, currentPlayer, state);
        return 0;
...
void cardBaron(int choice1, int handPos, int currentPlayer, struct gameState *state) {
