...
int main()
{
    ...
    for(i = 0; i < 5; i++){
        ...
        printf("Calling SeaHag function in cardEffect!\n");
        cardEffect(25, 0, 0, 0, &game, 4, 0);
    
        // Compare the before and after state of variables for player 1 and 2
        result = game.deck[1][game.deckCount[1]-1];
        printf("Last card in deck player 2: %d\n", result);
        if(result != 0){
    ...
    printf("All cardtest #4 testing is finished! \n");
