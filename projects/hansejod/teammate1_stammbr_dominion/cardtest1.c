...
int main()
{
    ...
    for(n=0; n < 10; n++){
        ...
        smithyMethod(&game, 0, 4);
        
        result4 = game.handCount[0];
        printf("Number of cards in hand: %d\n", result4);
        result4 -= 2;
        if(result1 != result4){
            printf("Bug Found! Number of cards in hand increased by more than two.\n");
        }
        ...
        result5 += 3;
        if(result1 != result5){
            printf("Bug Found! Number of cards in deck decreased by more than three.\n");
        }
    ...
    printf("All cardtest #1 testing is finished! \n");
    return 0;
}
